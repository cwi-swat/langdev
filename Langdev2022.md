...
Jasper Denkers: **Taming Complexity of Industrial Printing Systems Using a Constraint-Based DSL — An Industrial Experience Report** - [slides](slides/2022/0942.pdf)  
...
Lorenzo Addazi, Alessio Stalla: **StarLasu: an open-source methodology for parsers and transpilers** - [slides](slides/2022/5058.pdf)
...
In a demo, we’ll show our approach in action, by constructing an AST iteratively from a simple ANTLR parser, and showcasing tree traversal and transformation. We’ll use the Kotlin language. <br/><br/>
...
Meinte Boersma: **Language engineering for the masses: business rules for the EU DCC**  - [slides](slides/2022/7921.pdf)
